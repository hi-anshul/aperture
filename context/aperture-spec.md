# Aperture — Master Spec Document
> Personal job-search intelligence tool · Next.js + NestJS + PostgreSQL (Neon) + Connector SDK · v1.0

---

## 1. Product Overview

Aperture is a self-hosted tool that continuously watches a set of companies' careers pages, normalizes every job posting into one shape, and tells the user which postings are worth their time.
...
```
You are the Aperture's matching engine. Given a resume
...
*Last updated: July 2026 · Aperture v1.0 MVP spec*
